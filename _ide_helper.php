...
')
     ...
     */ 
        ...
        {
                        /** @var \Obiefy\API\ApiResponse $instance */
                        return $instance->response($status, $message, $data, ...$extraData);
        }
                    /**
        ...
        {
                        /** @var \Obiefy\API\ApiResponse $instance */
                        return $instance->ok($message, $data, ...$extraData);
        }
                    /**
         * Create successful (200) API response.
         *
        ...
        {
                        /** @var \Obiefy\API\ApiResponse $instance */
                        return $instance->success($message, $data, ...$extraData);
        }
                    /**
        ...
        {
                        /** @var \Obiefy\API\ApiResponse $instance */
                        return $instance->validation($message, $errors, ...$extraData);
        }
                    /**
         * Create Validation (422) API response.
         *
        ...
        {
                        /** @var \Obiefy\API\ApiResponse $instance */
                        return $instance->forbidden($message, $data, ...$extraData);
        }
                    /**
        ...
        {
                        /** @var \Obiefy\API\ApiResponse $instance */
                        return $instance->error($message, $data, ...$extraData);
        }
                    /**
         * Register a custom macro.
         *
        ...
        public static function macro($name, $macro)
        {
                        \Obiefy\API\ApiResponse::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Obiefy\API\ApiResponse::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Obiefy\API\ApiResponse::hasMacro($name);
        }
...
namespace  { 
            ...
            class API extends \Obiefy\API\Facades\API {}
